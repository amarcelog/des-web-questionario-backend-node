    ...
    paths: {
      ...
      '/perguntas': {
        post: {
          ...
          requestBody: {
            required: true,
            content: { 'application/json': { schema: { $ref: '#/components/schemas/Pergunta' } } }
          },
      ...
      '/opcoes': {
        post: {
          ...
          requestBody: {
            required: true,
            content: { 'application/json': { schema: { $ref: '#/components/schemas/Opcao' } } }
          },
      ...
      '/quest_respondidas': {
        post: {
          ...
          requestBody: {
            required: true,
            content: { 'application/json': { schema: { $ref: '#/components/schemas/QuestionarioRespondido' } } }
          },
          responses: { '201': { description: 'Questionário respondido criado com sucesso' } }
        },
        get: {
          tags: ['Questionários Respondidos'],
          ...
          responses: {
            '200': {
              description: 'Lista de questionários respondidos retornada com sucesso',
              content: {
                'application/json': {
                  schema: {
                    type: 'array',
                    items: { $ref: '#/components/schemas/QuestionarioRespondido' }
                  }
                }
              }
            }
      ...
      '/quest_respondidas/{id}': {
        ...
        patch: {
          ...
          responses: { '200': { description: 'Questionário respondido atualizado com sucesso' } }
        },
        delete: {
          tags: ['Questionários Respondidos'],
          summary: 'Deleta um questionário respondido',
          parameters: [{ in: 'path', name: 'id', required: true, schema: { type: 'integer' } }],
          responses: { '200': { description: 'Questionário respondido deletado com sucesso' } }
        }
      },
      '/quest_respondidas/{id}/finalizar': {
        put: {
          ...
          parameters: [{ in: 'path', name: 'id', required: true, schema: { type: 'integer' } }],
          responses: { '200': { description: 'Questionário respondido finalizado com sucesso' } }
        }
      },
      '/respostas': {
        post: {
